...
class UserProfile(models.Model):
    ...
    CASTE_CHOICES = (
        ...
        ('Agaria', 'Agaria'),
        ('Amat', 'Amat'),
        ('Ansari', 'Ansari (Muslim)'),
        ('Asura', 'Asura'),
        ('Atheet', 'Atheet'),
        ('Atith', 'Atith'),
        ('Awadh Bania', 'Awadh Bania'),
        ('Bagdi', 'Bagdi'),
        ('Baiga', 'Baiga'),
        ('Bakho', 'Bakho (Muslim)'),
        ('Bania', 'Bania'),
        ...
        ('Bedia', 'Bedia'),
        ('Beldar', 'Beldar'),
        ('Bengali Kayastha', 'Bengali Kayastha'),
        ('Bhaskar', 'Bhaskar'),
        ('Bhat', 'Bhat'),
        ('Bhathiyara', 'Bhathiyara (Muslim)'),
        ('Bhuiya', 'Bhuiya'),
        ('Bhuiyar', 'Bhuiyar'),
        ('Bhumihar', 'Bhumihar'),
        ('Bind', 'Bind'),
        ('Birjia', 'Birjia'),
        ('Boatman', 'Boatman'),
        ('Brahmabhatt', 'Brahmabhatt'),
        ('Brahmin', 'Brahmin'),
        ('Bread seller', 'Bread seller (Muslim)'),
        ('Burden', 'Burden'),
        ('Chero', 'Chero'),
        ('Chamar', 'Chamar'),
        ('Chamar-Rabidas', 'Chamar-Rabidas'),
        ('Chamar-Ravidas', 'Chamar-Ravidas'),
        ('Chamar-Rohidas', 'Chamar-Rohidas'),
        ('Chandravanshi', 'Chandravanshi'),
        ('Chapota', 'Chapota'),
        ('Charasia', 'Charasia'),
        ('Cheek', 'Cheek (Muslim)'),
        ('Chick Baraik', 'Chick Baraik'),
        ('Chudihar', 'Chudihar (Muslim)'),
        ('Christians (Harijans)', 'Christians (Harijans)'),
        ('Christians (OBC)', 'Christians (OBC)'),
        ('Cobbler', 'Cobbler'),
        ('Coal', 'Coal'),
        ('Costa', 'Costa'),
        ('Dabangg', 'Dabangg'),
        ('Dafali', 'Dafali (Muslim)'),
        ('Dangi', 'Dangi'),
        ('Devhar', 'Devhar'),
        ('Dhanuk', 'Dhanuk'),
        ('Dhanwar', 'Dhanwar'),
        ...
        ('Gulgulia', 'Gulgulia'),
        ('Gupta', 'Gupta'),
        ('Halalkhor', 'Halalkhor (Muslim)'),
        ('Halwai', 'Halwai'),
        ('Hari', 'Hari'),
        ('Hidden', 'Hidden'),
        ('Hijra', 'Hijra (Third Gender)'),
        ('Idrisi', 'Idrisi (Muslim)'),
        ('Irtpaz Ibrahimi', 'Irtpaz Ibrahimi (Muslim)'),
        ('Jadupitiya', 'Jadupitiya'),
        ('Jati', 'Jati'),
        ('Jat', 'Jat (Hindu/Muslim)'),
        ('Jogi', 'Jogi'),
        ('Jugi', 'Jugi'),
        ('Kadar', 'Kader'),
        ('Kahar', 'Kahar'),
        ...
        ('Khelta', 'Khelta'),
        ('Khond', 'Khond'),
        ('Kinnar', 'Kinnar (Third Gender)'),
        ('Koch', 'Koch'),
        ('Kora', 'Kora'),
        ('Korku', 'Korku'),
        ('Korwa', 'Korwa'),
        ('Kothi', 'Kothi (Third Gender)'),
        ('Kulhaiya', 'Kulhaiya'),
        ('Kunjra', 'Kunjra (Muslim)'),
        ('Kurariar', 'Kurariar'),
        ('Kurmi', 'Kurmi'),
        ('Kushwaha', 'Kushwaha'),
        ('Laheri', 'Laheri'),
        ...
        ('Majhwar', 'Majhwar'),
        ('Mehtar', 'Mehtar'),
        ('Miriyasin', 'Miriyasin (Muslim)'),
        ('Momin', 'Momin (Muslim)'),
        ('Morshikar', 'Morshikar (Muslim)'),
        ('Mudi-Kora', 'Mudi-Kora'),
        ('Munda', 'Munda'),
        ('Musahar', 'Musahar'),
        ('Nagar', 'Nagar'),
        ('Nagesia', 'Nagesia'),
        ('Nalband', 'Nalband (Muslim)'),
        ('Namashudras', 'Namashudras'),
        ('Nat', 'Nat (Muslim)'),
        ('Navesud', 'Navesud'),
        ('Noniya', 'Noniya'),
        ('Nut', 'Nut'),
        ...
        ('Rajwar', 'Rajwar'),
        ('Rangwa', 'Rangwa'),
        ('Rangrez', 'Rangrez (Muslim)'),
        ('Rastogi', 'Rastogi'),
        ('Rautia', 'Rautia'),
        ('Sainthwar', 'Sainthwar'),
        ('Sai', 'Sai (Muslim)'),
        ('Samari Vaishya', 'Samari Vaishya'),
        ('Santrash', 'Santrash'),
        ('Santal', 'Santal'),
        ...
        ('Sweeper', 'Sweeper'),
        ('Syed', 'Syed'),
        ('Tailor', 'Tailor (Muslim)'),
        ('Tailor (Hindu)', 'Tailor (Hindu)'),
        ('Tamaria', 'Tamaria'),
        ('Tamoli', 'Tamoli'),
        ('Tanner', 'Tanner'),
        ('Tea', 'Tea'),
        ('Thakurai', 'Thakurai (Muslim)'),
        ('Tharu', 'Tharu'),
        ('Tikulhar', 'Tikulhar'),
        ('Tilley', 'Tilley'),
        ('Turi', 'Turi'),
